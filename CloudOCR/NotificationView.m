...
- (void) layoutSubviews {
    ...
    CGFloat textSizeWidth = maxLabelSize.width;

    if([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)
    {
        textSizeWidth = (self.textLabel != nil) ? [self.textLabel boundingRectWithSize:maxLabelSize options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:self.label.font} context:nil].size.width : 0;
    }
